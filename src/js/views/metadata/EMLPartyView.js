        ...
        var EMLPartyView = Backbone.View.extend(
          ...
          showValidation: function() {
            ...
            isEmpty: function() {
                ...
                var attributes = ["country", "city", "administrativeArea", "postalCode",
                    "deliveryPoint","userId", "fax", "phone","onlineUrl", "email", "givenName",
                    "surName", "positionName", "organizationName"];
